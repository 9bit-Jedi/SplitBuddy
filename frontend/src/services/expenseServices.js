...
export const getUserDailyExpService = async (setAlert, setAlertMessage) => {
  try {
    ...
    setAlert(true);
    setAlertMessage(
      error.response?.data?.message || 'Failed to fetch daily expenses',
    );
    window.scroll(0, 0);
  }
};
...
export const getUserMonthlyExpService = async (setAlert, setAlertMessage) => {
  try {
    ...
    setAlert(true);
    setAlertMessage(
      error.response?.data?.message || 'Failed to fetch monthly expenses',
    );
    window.scroll(0, 0);
  }
};
...
export const settleExpenseService = async (
  expenseId,
  setAlert,
  setAlertMessage,
) => {
...
export const getGroupExpensesService = async (
  groupId,
  setAlert,
  setAlertMessage,
) => {
...
export const getGroupBudgetService = async (
  groupId,
  setAlert,
  setAlertMessage,
) => {
  try {
    ...
    setAlert(true);
    setAlertMessage(
      error.response?.data?.message || 'Failed to fetch group budget',
    );
    window.scroll(0, 0);
  }
};

export const getGroupCategorySpendingService = async (
  groupId,
  setAlert,
  setAlertMessage,
) => {
  try {
    ...
    setAlert(true);
    setAlertMessage(
      error.response?.data?.message || 'Failed to fetch category spending',
    );
    window.scroll(0, 0);
  }
};

export const getGroupLeaderboardService = async (
  groupId,
  setAlert,
  setAlertMessage,
) => {
