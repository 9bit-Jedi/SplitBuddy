...
export default function Dashboard() {
    ...
    useEffect(() => {
        const getUserDetails = async () => {
            setLoading(true);
            const response_group = await getUserGroupsService(setAlert, setAlertMessage)
            if (response_group.length === 0){
                ...
                const response_expense = await getGroupExpensesService(response_group[0].id, setAlert, setAlertMessage)
