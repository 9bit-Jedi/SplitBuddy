...
// material
import {  Stack,  TextField, IconButton, InputAdornment,  Snackbar, Alert, Typography, Link } from '@mui/material';
...
export default function RegisterForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      await authService.register(values, setShowAlert, setAlertMessage)
    },
  });
